...
const Interface = ({
  ...
  //main logic of how to score the player's move
  ...
  return (
    <div>
      {pressState.map((move, index) => {
        return (
          <>
            {!spacePressed && !showArrows ? (
              <Arrows move={move} index={index} setArrows={setArrows} arrows={arrows} key={index} />
            ) : null}
          </>
        )
      })}
